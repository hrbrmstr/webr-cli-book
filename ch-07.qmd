...
We go back to our regularly scheduled programming in the next chapter and look at how to embed a [toy] model into our CLI, let the user ask a question, and have it write results out back to the filesystem.
