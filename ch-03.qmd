...
```{json, filename="ch-03/pacakge.json"}
{
  "name": "hello-pkgs",
  "version": "0.1.0",
...
```{js, eval=FALSE, filename= "ch-04/index.mjs"}
...
In the next chapter we'll cover how to store all those depended packages on the local filesystem and use them with WebR in Node.
